...
int main( int argc, char* argv[] ) {
  ...
  // Geometry
  pf.addBox( 0.70, 0.06, 0.06, 0.05, 0.36, 0.00 );
  pf.addBox( 0.06, 0.06, 0.62, 0.05, 0.36, 0.06 ); 
  pf.addBox( 0.06, 0.06, 0.62, 0.37, 0.36, 0.06 );
  pf.addBox( 0.06, 0.06, 0.62, 0.69, 0.36, 0.06 );

  pf.addBox( 0.70, 0.06, 0.06, 0.05, 0.36, 0.74 );
  pf.addBox( 0.06, 0.06, 0.62, 0.21, 0.36, 0.12 ); 
  pf.addBox( 0.06, 0.06, 0.62, 0.53, 0.36, 0.12 );
  ...
  goal[0] = 0.7; goal[1] = 0.55; goal[2] = 0.50;
  std::vector<double> start(3);
  start[0] = 0.20; start[1] = 0.20; start[2] = 0.30;
